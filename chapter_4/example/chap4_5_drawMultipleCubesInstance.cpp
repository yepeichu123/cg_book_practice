...
int main(int argc, char** argv) {
    ...
    GLFWwindow* window = glfwCreateWindow(600, 600, "chapter4_5_drawMultipleCubesInstance", NULL, NULL);
...
void init(GLFWwindow* window) {
    ...
    renderingProgram = pUtils->runCreateShaderProgram(
        string("./config/vertShaderInstance.glsl"), string("./config/fragShaderInstance.glsl"));
...
void display(GLFWwindow* window, double currentTime) {
    ...
    if (indexSaveImg == 5000 && saveImgTimes < 3) {
        string imgPath = "./result/drawMultipleCubesInstance";
        if (saveImgTimes == 0) {
            imgPath += "_1.png";
        }
